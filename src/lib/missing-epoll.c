...
#if !defined(turboserve_HAVE_EPOLL) && defined(turboserve_HAVE_KQUEUE)
#include <sys/event.h>
#include <sys/time.h>
#include <sys/types.h>
...
{
#if defined(turboserve_HAVE_KQUEUE1)
...
int epoll_wait(int epfd, struct epoll_event *events, int maxevents, int timeout)
{
    ...
    struct kevent *evs = alloca(sizeof(*evs) * turboserve_MIN(1024, maxevents));
...
#elif !defined(turboserve_HAVE_EPOLL)
