...
#define turboserve_HAVE_SECURE_GETENV
#endif
#if defined(__GLIBC_PREREQ) && __GLIBC_PREREQ(2, 19)
#define turboserve_HAVE_MKOSTEMPS
#endif
#if defined(__GLIBC_PREREQ) && __GLIBC_PREREQ(2, 7)
#define turboserve_HAVE_CORRECT_UMASK_TMPFILE
#endif
#endif

#if !defined(turboserve_HAVE_SECURE_GETENV)
...
#if defined(turboserve_HAVE_CORRECT_UMASK_TMPFILE)
